...
ifeq ($(OS), Darwin)
	curl https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/operator-sdk/4.14.10/operator-sdk-darwin-x86_64.tar.gz? | tar -xz -C bin/
else
	curl https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/operator-sdk/4.14.10/operator-sdk-linux-x86_64.tar.gz? | tar -xz -C bin/
endif
endif
